...
class Controller:
    ...
    @staticmethod
    def get_titles_from_movies(ordered_movies):
        """
        This method will get titles from the received movie list.
        :param ordered_movies: Received movie list.
        :return: A list of movie titles.
        """
        titles = []
        for movie in ordered_movies:
            titles.append(movie.get_title())
        return titles

    @staticmethod
    def calculate_price(movies):
        """
    ...
    def update_repositories(self):
        """
        This method will update repositories before of closing the program.
        """
        self.repositories.update_files()
